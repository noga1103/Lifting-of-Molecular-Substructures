...
class CWNModel(torch.nn.Module):
    def __init__(
        ...
        self.layers = torch.nn.ModuleList([
            CWNLayer(
                in_channels_0=self.in_channels_0,
                in_channels_1=self.in_channels_1,
                in_channels_2=self.in_channels_2,
    ...
    def forward(self, graph):
        ...
        adjacency_1, incidence_2, incidence_1_t = (
            graph.graph_matrices["adjacency_1"],
            graph.graph_matrices["incidence_2"],
            graph.graph_matrices["incidence_1_t"]
        )
    ...
    def add_graph_matrices(enhanced_graph):
        ...
        incidence_1_t = enhanced_graph.cell_complex.incidence_matrix(rank=1).T
